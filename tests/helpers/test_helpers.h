 ...
 *
  runWithinPluginEditor ([&] (NatorsynthAudioProcessor& plugin) {
 ...
 */
[[maybe_unused]] static void runWithinPluginEditor (const std::function<void (NatorsynthAudioProcessor& plugin)>& testCode)
{
